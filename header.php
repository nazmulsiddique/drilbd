...
<!-- SITE TITLE -->
<title>DAILY RICE INDUSTRIES LIMITED</title>
<!-- Favicon Icon -->
...
<!-- START HEADER -->
<header class="header_wrap dark_skin main_menu_uppercase bg_gray">
            ...
            <div class="row align-items-center">
                <div class="col-md-12">
                	<ul class="contact_detail border_list list_none text-center text-md-right">
                        ...
                        <li><a href="#"><i class="ti-email"></i> <span><span class="__cf_email__" data-cfemail="5d34333b321d2432282f303c3431733e3230">[email&#160;protected]</span></span></a></li>
                    </ul>
                </div>
                <div class="col-md-5">
    ...
    <div class="container">
        <nav class="navbar navbar-expand-lg"> 
            <a class="navbar-brand" href="http://192.168.9.222:8080/drilbd/">
                <img class="logo_light" src="assets/images/logo_white.png" alt="logo" />
                <img class="logo_dark" src="assets/images/logo_dark_2.png" width="100px" alt="logo" />
                <img class="logo_default" src="assets/images/logo_dark_1.png" alt="logo" />
            </a>
            <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation"> <span class="ion-android-menu"></span> </button>
            <div class="collapse navbar-collapse justify-content-end" id="navbarSupportedContent">
				<ul class="navbar-nav">
                    <li class="dropdown">
                        <a class="nav-link active" href="http://192.168.9.222:8080/drilbd/">Home</a>
			...
			<ul class="contact_detail border_list list_none text-center text-md-right">
                        <li><a href="#"><i class="ti-mobile"></i> <span>01678-575851</span></a></li>
                        <li><a href="#"><i class="ti-email"></i> <span><span class="__cf_email__" data-cfemail="5d34333b321d2432282f303c3431733e3230">dailyriceindustryltd@gmail.com</span></span></a></li>
                    </ul>
        </nav>
    </div>
</header>
